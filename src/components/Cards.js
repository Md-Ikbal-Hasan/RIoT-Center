        ...
        <div className='my-5'>
            ...
            <div className="row g-3 mx-3">
                ...
                <div className="col-md-4 col-12">
                    <div className="card shadow-lg border-5 border-primary">
                        <img className="card-img-top img-fluid rounded-circle" src="https://images.unsplash.com/photo-1555664424-778a1e5e1b48?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="Card image cap" />
                ...
                <div className="col-md-4 col-12">
                    <div className="card shadow-lg border-5 border-primary">
                        <img className="card-img-top img-fluid rounded-circle" src="https://images.unsplash.com/photo-1576671414121-aa0c81c869e1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="Card image cap" />
                        <div className="card-body">
